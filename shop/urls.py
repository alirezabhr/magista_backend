...
urlpatterns = [
    ...
    path('creation-step/<str:ig_username>/', views.ShopCreationView.as_view(), name='shop-creation-step'),
    ...
    path('instagram-username/<str:ig_username>/', views.ShopView.as_view(), name='shop-data'),    # for vendor
